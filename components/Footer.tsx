...
const REMIX_IDEAS = [
    "to create an 80s workout vibe.",
    "to generate high-fashion runway looks.",
    "to try futuristic sci-fi outfits.",
    "to reimagine yourself in Victorian era clothing.",
    "to see how you look in grunge style.",
    "to design a custom cosplay character.",
];
