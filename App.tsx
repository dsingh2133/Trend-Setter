...
const STYLES = ['Streetwear', 'Old Money', 'Y2K', 'Cyberpunk', 'Cottagecore', 'Dark Academia'];
...
function App() {
    ...
    const handleGenerateClick = async () => {
        ...
        const processStyle = async (style: string) => {
            try {
                const prompt = `Reimagine the person in this photo wearing a ${style} outfit. This includes clothing, hairstyle, and the overall aesthetic of the ${style} fashion trend. The output must be a photorealistic image showing the person clearly.`;
    ...
    const handleDownloadIndividualImage = (style: string) => {
        ...
        if (image?.status === 'done' && image.url) {
            ...
            link.href = image.url;
            link.download = `trend-setter-${style.toLowerCase().replace(/\s+/g, '-')}.jpg`;
    ...
    const handleDownloadAlbum = async () => {
        ...
        try {
            // Explicitly cast entries to ensure TS knows the type of image
            ...
            link.download = 'trend-setter-album.jpg';
            document.body.appendChild(link);
            link.click();
            document.body.removeChild(link);
        ...
        <main className="bg-black text-neutral-200 min-h-screen w-full flex flex-col items-center justify-center p-4 pb-24 overflow-hidden relative">
            ...
            <div className="z-10 flex flex-col items-center justify-center w-full h-full flex-1 min-h-0">
                <div className="text-center mb-10">
                    <h1 className="text-6xl md:text-8xl font-caveat font-bold text-neutral-100">Trend Setter</h1>
                    <p className="font-permanent-marker text-neutral-300 mt-2 text-xl tracking-wide">Visualize yourself in trending fashion aesthetics.</p>
                </div>
                     ...
                     <div className="relative flex flex-col items-center justify-center w-full">
                        ...
                        >
                            ...
                            <p className="mt-8 font-permanent-marker text-neutral-500 text-center max-w-xs text-lg">
                                Click the polaroid to upload your photo and try on new styles.
                            </p>
                        </motion.div>
                    </div>
                )}
